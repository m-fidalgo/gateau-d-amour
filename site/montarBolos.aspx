<%@ Page Title="" Language="C#" MasterPageFile="~/mPage.master" AutoEventWireup="true" MaintainScrollPositionOnPostback="true" CodeFile="~/cs/montarBolos.aspx.cs" Inherits="montarBolos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="divProg">
        <br />
        <br />
        <h1 class="h1M">Monte seu Bolo!</h1>
        <br />
      ...
      <div id="esquerda">
	    ...
	    <div class="flashContent">
           <img style="width: 100%;" src="anim/animBolo.gif" />
        </div>
      </div>
      ...
      <div id="direita">
        ...
        <asp:SqlDataSource ID="sqlCadastrar" runat="server" ConnectionString="<%$ ConnectionStrings:gateaudamourConnectionString %>" InsertCommand="INSERT INTO produto(id_prod, id_tamanho, nome_prod, preco_prod, camadas_bolo, andares_bolo, status_prod, comentario_prod, imagem) VALUES (0, @TAM, 'Personalizado', @PRECO, @CAMADAS, @ANDARES, 'Temporário', @COMENT, 'noImg.png')" ProviderName="<%$ ConnectionStrings:gateaudamourConnectionString.ProviderName %>" SelectCommand="SELECT max(id_prod) AS idMax FROM produto">
            <InsertParameters>
                <asp:ControlParameter ControlID="ddlTamanho" Name="TAM" PropertyName="SelectedValue" />
                <asp:Parameter Name="PRECO" />
                <asp:ControlParameter ControlID="txtCamadas" Name="CAMADAS" PropertyName="Text" />
                <asp:ControlParameter ControlID="txtAndares" Name="ANDARES" PropertyName="Text" />
