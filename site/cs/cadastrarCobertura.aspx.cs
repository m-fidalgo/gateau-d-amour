...
public partial class cadastrarCobertura : System.Web.UI.Page
{
    ...
    protected void btnCadastrar_Click(object sender, EventArgs e)
    {
        ...
        {
            //insert
            sqlCadastrarCobertura.InsertParameters["PRECOADC"].DefaultValue = txtPrecADC.Text.Replace(',', '.');
            sqlCadastrarCobertura.Insert();
