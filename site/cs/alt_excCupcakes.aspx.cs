...
public partial class alt_excCupcakes : System.Web.UI.Page
{
    ...
    protected void ddlCupcakes_SelectedIndexChanged(object sender, EventArgs e)
    {
        if(ddlCupcakes.SelectedItem.Text == "SELECIONE")
        {
            lbl1.Text = "Selecioneum valor";
        }
        else
        {
            DataView dvCupcakes = (DataView)sqlCupcakes.Select(DataSourceSelectArguments.Empty);

            //carregando a página
            txtNome.Text = dvCupcakes.Table.Rows[0]["nome_prod"].ToString();
            lblTamanho.Text = dvCupcakes.Table.Rows[0]["descr_tamanho"].ToString();
            lblGen.Text = dvCupcakes.Table.Rows[0]["nome_genero"].ToString();
            lblFormato.Text = dvCupcakes.Table.Rows[0]["descr_formato"].ToString();
            lblMassa.Text = dvCupcakes.Table.Rows[0]["nome_massa"].ToString();
            lblCorMassa.Text = dvCupcakes.Table.Rows[0]["corMassa"].ToString();
            lblCobertura.Text = dvCupcakes.Table.Rows[0]["nome_cobertura"].ToString();
            lblCorCobertura.Text = dvCupcakes.Table.Rows[0]["corCobertura"].ToString();
            lblDecor.Text = dvCupcakes.Table.Rows[0]["descr_decor"].ToString();
            lblCorDecor.Text = dvCupcakes.Table.Rows[0]["corDecor"].ToString();
            lblRecheio.Text = dvCupcakes.Table.Rows[0]["nome_recheio"].ToString();
            lblSaborRecheio.Text = dvCupcakes.Table.Rows[0]["desc_sabor"].ToString();
            imgBolo.Visible = true;
            imgBolo.ImageUrl = "~\\imgs\\produtos\\" + dvCupcakes.Table.Rows[0]["imagem"].ToString();
    ...
    protected void btnAlterar_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            else
            {
                ...
                txtImg.Text = "";
                txtNome.Text = "";
                imgBolo.ImageUrl = ""; Session["precoTam"] = null;
