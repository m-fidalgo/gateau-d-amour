...
public partial class cadastrarDecoracao : System.Web.UI.Page
{
    ...
    protected void btnCadastrar_Click(object sender, EventArgs e)
    {
        ...
        {
            //insert
            sqlCadastrarDecoracao.InsertParameters["PRECOADC"].DefaultValue = txtPrecADC.Text.Replace(',', '.');
            sqlCadastrarDecoracao.Insert();
