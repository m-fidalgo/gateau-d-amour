<%@ Page Title="" Language="C#" MasterPageFile="~/mPageAdm.master" AutoEventWireup="true"  MaintainScrollPositionOnPostback="true" CodeFile="~/cs/alt_excBolos.aspx.cs" Inherits="alt_excBolos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="divProg">
        ...
        <asp:DropDownList ID="ddlTamanho" runat="server" CssClass="ddl" DataSourceID="sqlCarregarTamanho" DataTextField="descr_tamanho" DataValueField="id_tamanho" Enabled="False" OnSelectedIndexChanged="ddlTamanho_SelectedIndexChanged"></asp:DropDownList>
        <p><asp:Label ID="lbl1Tam" runat="server" CssClass="rfv"></asp:Label></p>
        <asp:SqlDataSource ID="sqlCarregarTamanho" runat="server" ConnectionString="<%$ ConnectionStrings:gateaudamourConnectionString %>" ProviderName="<%$ ConnectionStrings:gateaudamourConnectionString.ProviderName %>" SelectCommand="SELECT id_tamanho, id_formato, id_cat, descr_tamanho, medidas_tamanho, preco_tamanho FROM tamanho WHERE (id_cat = 1) AND (id_formato = @IDFORM)">
            <SelectParameters>
        ...
        <p>Camadas:</p>
        <asp:TextBox ID="txtCamadas" placeholder="EX: 2" runat="server" CssClass="txt"></asp:TextBox>
        <br />

        <p>Andares:</p>
        <asp:TextBox ID="txtAndares" placeholder="EX: 1" runat="server" CssClass="txt"></asp:TextBox>
        <br />
        ...
        <br />
        <asp:SqlDataSource ID="sqlAltProd" runat="server" ConnectionString="<%$ ConnectionStrings:gateaudamourConnectionString %>" DeleteCommand="DELETE FROM produto WHERE (id_prod = @ID)" ProviderName="<%$ ConnectionStrings:gateaudamourConnectionString.ProviderName %>" SelectCommand="SELECT * FROM [produto]" UpdateCommand="UPDATE produto SET id_tamanho = @TAM, nome_prod = @NOME, camadas_bolo = @CAM, andares_bolo = @AND , imagem = @IMG, preco_prod = @PRECO WHERE (id_prod = @ID)">
            <DeleteParameters>
                <asp:ControlParameter ControlID="ddlBolos" Name="ID" PropertyName="SelectedValue" />
            </DeleteParameters>
            <UpdateParameters>
                ...
                <asp:ControlParameter ControlID="txtCamadas" Name="CAM" PropertyName="Text" />
                <asp:ControlParameter ControlID="txtAndares" Name="AND" PropertyName="Text" />
                <asp:ControlParameter ControlID="ddlBolos" Name="ID" PropertyName="SelectedValue" />
